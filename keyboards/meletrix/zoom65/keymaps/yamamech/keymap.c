...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_all(
        ...
        KC_LCTL, KC_LGUI, LM_LALT,                   KC_SPC,  KC_SPC,  KC_SPC,           KC_RALT, FN,               KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_FN] = LAYOUT_all(
        ...
        _______, _______, _______,                   KC_MPLY, KC_MPLY, KC_MPLY,          _______, _______,          KC_MPRV, _______, KC_MNXT
    ),
